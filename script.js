const screens = [
...

    {
        id: 14,
        type: "final",
        title: "Это финал чек‑апа и важный шаг к цели",
        finalMessage:
            "Главное уже сделано. Непросто преодолеть себя и искренне спросить: Чего я на самом деле хочу? Куда я реально иду?\nЧтобы результат стал реальным, важно завершить этот шаг реальным действием.",
        finalQuestions: [
            "Что для тебя сейчас стало яснее?",
            "Какой шаг ты хочешь сделать в ближайшие 24 часа?"
        ],
        finalShareText:
            "Поделись чек‑апом с человеком, которому желаешь роста.\nТак ты сможешь давать поддержку окружающим и получать её.",
        ...
        finalNextText: "Получить персональный следующий шаг.\nЗабрать $ награду за прохождение чек‑апа.\nЕще много заданий и $$ наград в Abundance Effect.",
