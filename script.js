const screens = [
    ...
    },
    {
        ...
        miniChoices: [
            ...
            },
            {
                ...
                hint: "Системы могут усиливать этот выбор →"
            }
        ]
    },
    {
        ...
        miniChoices: [
            {
                ...
                hint: "Есть системы,\nгде рост не обязательно означает борьбу →"
            },
            {
    ...
    // },
    {
        ...
        feedbacks: [
            "Тебя цепляет ощущение свободы.\n\nКогда человек сам выбирает маршрут,\nне нуждается в одобрении\nи спокойно следует своим решениям —\nэто вызывает уважение и внутренний отклик.\n\nВ этом есть воздух,\nи хочется дышать так же.",
            "Тебя трогает честность и открытость.\n\nКогда говорят прямо,\nне прячут мотивы\nи остаются ясными в сложных разговорах —\nэто создаёт ощущение доверия.\n\nТы ценишь прозрачность,\nв которой можно быть собой.",
            "Тебя цепляет масштаб и чувство возможного.\n\nКогда человек уверенно занимает место,\nумеет открывать двери\nи расширяет горизонты —\nэто пробуждает азарт и интерес.\n\nВ этом есть сигнал:\n«границы можно двигать».",
            "Тебя притягивает лёгкость и комфорт.\n\nКогда рядом с человеком тепло,\nменьше напряжения\nи больше жизненной простоты —\nэто наполняет и даёт опору.\n\nТы откликаешься на состояние,\nв котором приятно быть.",
            "Тебя цепляет близость по интересам.\n\nКогда есть общие темы,\nсовпадают ценности\nи разговоры текут легко —\nпоявляется ощущение «своего круга».\n\nЭто про соединённость и взаимность.",
            "Тебя привлекает энергия и амбиция.\n\nКогда человек заряжен,\nдвигается к целям\nи не боится скорости —\nэто поднимает тонус и вдохновляет.\n\nТы чувствуешь импульс,\nкоторый хочется поддержать."
        ],
        miniChoices: [
            {
                question: "Где тебе важнее свобода?",
            ...
            },
            {
                ...
                hint: "Ясность часто снимает внутреннее напряжение →"
            },
            {
                ...
                hint: "Возможности растут,\nкогда понятно, на что опираться →"
            },
            {
