const screens = [
...

    {
        id: 14,
        type: "final",
        title: "Это финал чек‑апа и ещё один шаг к твоей цели",
        finalMessage:
            "Главное уже сделано. Преодолеть себя и спросить: Чего я на самом деле хочу? Куда я реально иду? - необходимо для достижения цели.\nЧтобы это не было впустую, важно завершить шаг реальным действием.",
        finalQuestions: [
            "Что для тебя сейчас стало яснее?",
            "Какой шаг ты готов(а) сделать в ближайшие 24 часа?"
        ],
        finalShareText:
            "Поделись чек‑апом с человеком, которому желаешь роста.\nТак вы сможете поддержать друг друга в следующих шагах.",
        shareUrl: "https://abundance-checkup.vercel.app/",
        shareMessage: "Прошёл(ла) чек‑ап Abundance Checkup. Он помогает понять, что важно именно сейчас. Возможно, тебе тоже откликнется.",
        shareHint: "Ссылка скопирована.",
        finalNextTitle: "Какой можно сделать следующий шаг?",
        finalNextText: "Получить персональный следующий шаг. Забрать денежную $ награду за прохождение чек‑апа. И множество заданий и $$ наград в Abundance Effect.",
        nextProductTitle: "Abundance Effect! 🎯",
        nextProductSubtitle: "Практичный инструмент для ясности, фокуса и движения к целям.",
...
function showResult(screen, optionIndex) {
    ...
    resultText.textContent = `Твой текущий фокус: ${title}.\n\n${feedback}`;
