const screens = [
    ...
    },
    {
        ...
        feedbacks: [
            "Тебя напрягает неизвестность впереди.\nКогда правила меняются,\nхочется больше ясности и опор.\n\nТревожит не путь,\nа отсутствие ориентиров:\nкуда идти дальше\nи на что опираться.\n\nТебе важно чувство направления.",
            "Ты видишь, как быстро меняется мир,\nи в этом много неопределённости.\nВозникает вопрос:\nгде будет твоё место и польза.\n\nТебе важно оставаться нужным\nи чувствовать вклад.\nЭто про ценность, а не про конкуренцию.",
            "Тебе важно сохранить то,\nчто уже построено.\nЕсть ощущение, что опора может стать тоньше,\nи хочется больше устойчивости.\n\nЭто про бережность к своему пути\nи желание иметь запас прочности.",
            "Для тебя важны настоящие связи.\nКогда рядом мало близости,\nстановится особенно тихо внутри.\n\nТебе нужна поддержка, живой контакт\nи чувство «мы вместе».\nЭто про близость, а не про шум.",
            "Тебе хочется реализоваться\nи видеть движение вперёд.\nИногда появляется тревога,\nчто усилия могут не дать результата.\n\nТебе важно чувствовать прогресс\nи свой собственный темп.",
            "Тебе важно оставаться человеком,\nкоторому можно доверять.\nХочется не размывать границы,\nа жить по своим ценностям.\n\nЭто про внутренний ориентир\nи спокойную совесть."
        ],
        miniChoices: [
            {
        ...
        miniChoices: [
            {
                ...
                hint: "Окружение можно выстраивать осознанно →"
            },
            {
            ...
            },
            {
                ...
                hint: "Навыки быстрее растут в практике →"
            },
            {
                ...
                hint: "Видимость можно усиливать системно →"
            },
            {
